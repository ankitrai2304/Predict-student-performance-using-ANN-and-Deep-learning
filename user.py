...
with col1:
    ...
    famsize = st.selectbox('Family Size', ['LE3', 'GT3'], help="LE3: Less or equal to 3, GT3: Greater than 3")
    Pstatus = st.selectbox('Parent\'s Cohabitation Status', ['T', 'A'], help="T: Together, A: Apart")
